...
const getURLFromGGG = async searchJsonReady => {
    try {
        ...
        const res = await fetch('https://www.pathofexile.com/api/trade/search/Sentinel', requestOption) //TODO 要改成新聯盟 Sentinel
        await delay(3000)
...
const noDelayURLFromGGG = async searchJsonReady => {
    try {
        const requestOption = {
            method: 'POST',
            headers: {
